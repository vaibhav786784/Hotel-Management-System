...
# Title label
title_label = Label(root, text="------------  HOTEL MANAGEMENT SYSTEM ------------", fg="black", height=2, font=('Orbitron', 16), bg="orange")
title_label.pack(fill=X)

# Welcome label
welcome_label = Label(root, text="================  WELCOME  ================", bg="#ae9cd0", fg="black", font=('Orbitron', 25))
...
# image
image1 = PhotoImage(file="images/top.png")
